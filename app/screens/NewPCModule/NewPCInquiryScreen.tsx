...
export const NewPCInquiryScreen: FC<StackScreenProps<AppStackParamList, "NewPCInquiry">> = observer(
  ({ navigation, route }) => {
    ...
    const getDataRequests = async () => {
      try {
        ...
        let responseNewPC = await api.get(apiRoutes.newPC.getNewPCs)

        if (responseNewPC.status === 200) {
          setPCData(responseNewPC.data.newPCs as PC[])
          setFilteredPCData(responseNewPC.data.newPCs as PC[])
            ...
            {isLoadingData ? (
              ...
              <>
                ...
                >
                  ...
                  <Text text="Equipos nuevos" style={$title} />
                ...
                <TouchableOpacity
                  ...
                  style={$fab}
                  onPress={() =>
                    navigation.navigate("AddNewPC", { willRefresh: route.params?.willRefresh })
                  }
                >
