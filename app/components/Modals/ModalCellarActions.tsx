...
import { PC, ubication } from "../../utils/interfaces"
...
interface ModalPCActionsProps {
  isVisible: boolean
  setIsVisible: (isVisible: boolean) => void
  cellarUbicationData: ubication
  willRefresh: boolean
}

export const ModalCellarActions = (props: ModalPCActionsProps) => {
  const { isVisible, setIsVisible, cellarUbicationData, willRefresh } = props
    ...
    },
    {
      ...
      onPress: async () => {
        ...
        let response = await api.delete(
          `${apiRoutes.cellar.deleteCellarUbication}/${cellarUbicationData._id}`,
        )
      ...
      <View style={$centeredView}>
        <View style={$modalView}>
          ...
          <View style={$headerContainer}>
            <Text
              style={$header}
              text={`Bodega ${cellarUbicationData.cellarNumber}, estantería ${cellarUbicationData.shelve}`}
            />
          </View>
