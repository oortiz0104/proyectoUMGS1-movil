...
export const ModalNewPCActions = (props: ModalPCActionsProps) => {
  ...
  const customerOptionsList = [
    ...
    },
    {
      ...
      onPress: async () => {
        Vibration.vibrate(1000)
        let response = await api.post(`${apiRoutes.newPC.checkOut}/${pcData._id}`)
    ...
    },
    {
      ...
      onPress: async () => {
        Vibration.vibrate(1000)
        let response = await api.delete(`${apiRoutes.newPC.deleteNewPC}/${pcData._id}`)
